export const ui = {
  en: {
    ...
    'lab.greetings.0': 'Welcome to the Lab!',
    'lab.greetings.1': 'Experiments are brewing...',
    'lab.greetings.2': 'Innovation happens here',

    // Search
    'search.placeholder': 'Search...',
    'search.noResults': 'No results found',
    'search.categories.blog': 'Blog Posts',
  ...
  it: {
    ...
    // Blog
    'blog.title': 'Blog',
    'blog.subtitle': 'Pensieri, tutorial e approfondimenti',
    'blog.noPosts': 'Nessun post ancora. Torna presto!',
    ...
    'lab.greetings.0': 'Benvenuto nel Lab!',
    'lab.greetings.1': 'Esperimenti in corso...',
    'lab.greetings.2': "L'innovazione nasce qui",

    // Search
    'search.placeholder': 'Cerca...',
    'search.noResults': 'Nessun risultato',
    'search.categories.blog': 'Post del Blog',
    'search.categories.projects': 'Progetti',
    ...
    'a11y.toggleLanguage': 'Cambia lingua',
